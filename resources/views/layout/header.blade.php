                        ...
                        <div class="accont-wishlist-cart-area-header">
                            ...
                            <div class="btn-border-only cart category-hover-header">
                                ...
                                <div class="category-sub-menu card-number-show">
                                    <h5 class="shopping-cart-number">Keranjang Belanja (03)</h5>
                                    ...
                                    <div class="sub-total-cart-balance">
                                        <div class="bottom-content-deals mt--10">
                                            <div class="top">
                                                <span>Sub Total:</span>
                                                <span class="number-c">39.500</span>
                                            </div>
                                            <div class="single-progress-area-incard">
                                                <div class="progress">
                                                    <div class="progress-bar wow fadeInLeft" role="progressbar" style="width: 45%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                            <p>Habiskan Lebih Banyak <span>100.000</span> untuk <span>gratis pulsa</span></p>
                                        </div>
                                        <div class="button-wrapper d-flex align-items-center justify-content-between">
                                            <a href="{{ route('whislist') }}" class="rts-btn btn-primary ">View Cart</a>
                                            <a href="checkout.html" class="rts-btn btn-primary border-only">CheckOut</a>
                                        </div>
                                    </div>
                                </div>
                                <a href="{{ route('whislist') }}" class="over_link"></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="nav-area">
                            <nav>
                                <ul class="parent-nav">
                                    ...
                                    <li class="parent"><a href="{{ route('shop') }}">Shop</a></li>
                                    <li class="parent"><a href="{{ route('whislist') }}">Keranjang</a></li>
                                </ul>
                            </nav>
                        </div>
                        <!-- button-area -->
                    ...
                    <div class="logo-search-category-wrapper after-md-device-header">
                        ...
                        <div class="main-wrapper-action-2 d-flex">
                            <div class="accont-wishlist-cart-area-header">
                                ...
                                <a href="{{ route('whislist') }}" class="btn-border-only wishlist">
