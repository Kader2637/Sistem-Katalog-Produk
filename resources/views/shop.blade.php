            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="navigator-breadcrumb-wrapper">
                        ...
                        <a class="current" href="{{ route('shop') }}">Pembelian</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                <div class="col-xl-3 col-lg-12 pr--70 pr_lg--10 pr_sm--10 pr_md--5 rts-sticky-column-item">
                    <div class="sidebar-filter-main theiaStickySidebar">
                        ...
                        <div class="single-filter-box">
                            <h5 class="title">Kategori Product</h5>
                            <div class="filterbox-body">
                                ...
                                <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="single-shopping-card-one">
                                        ...
                                        <div class="body-content">
                                            ...
                                            <a href="{{ route('detail') }}">
                                                <h4 class="title">Susu Aptamil</h4>
                                            </a>
                                            <span class="availability">500g Pack</span>
                                            <div class="price-area">
                                                <span class="current">Rp.30.000</span>
                                                <div class="previous">Rp.20.000</div>
                                            </div>
                                ...
                                <div class="col-lg-20 col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="single-shopping-card-one">
                                        ...
                                        <div class="body-content">
                                            ...
                                            <a href="{{ route('detail') }}">
                                                <h4 class="title">Juice Aplle</h4>
                                            </a>
                                            <span class="availability">500g Pack</span>
                                            <div class="price-area">
                                                <span class="current">Rp.40.000</span>
                                                <div class="previous">Rp.70.000</div>
                                            </div>
                                            <div class="cart-counter-action">
                                                <div class="quantity-edit">
                                                    <input type="text" class="input" value="1">
                                    ...
                                    <div class="single-shopping-card-one discount-offer">
                                        ...
                                        <div class="body-content">
                                            <div class="title-area-left">
                                                ...
                                                <span class="availability">500g Pack</span>
                                                <div class="price-area">
                                                    <span class="current">Rp.50.000</span>
                                                    <div class="previous">Rp.500.000</div>
                                                </div>
                                                <div class="cart-counter-action">
                                                    <div class="quantity-edit">
                                                        <input type="text" class="input" value="1">
